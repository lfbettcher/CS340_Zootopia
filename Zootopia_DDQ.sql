...
INSERT INTO `Animals` VALUES (1,'Lion','F','Lucy',4,510.30,'Bitey',2),(2,'Monkey','F','Sheryl',10,32.21,'Lovely',1),(3,'Elephant','M','Hank',34,1289.34,'Friendly',3),(4,'Zebra','M','Steve',12,435.87,'Moody',4),(5,'Lion','M','Larry',18,575.98,'Lazy',2),(6,'Monkey','M','Steve',3,22.34,'Energetic',1),(7,'Zebra','F','Sasha',10,770.23,'Friendly',4);
...
INSERT INTO `Zookeepers` VALUES (1,'Dottie','Duddleton'),(2,'Blanche','Devereaux'),(3,'Ricky','Robbie'),(4,'Jemaine','Clement'),(5,'Zoe','Kravitz');
